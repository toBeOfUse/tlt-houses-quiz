<script lang="ts">
	...
	const items = [
		...
		},
		{
			...
			description: "We can't fault you for practicality.",
			housePoints: {
				'1': 1,
				'2': 9,
				'3': 1,
